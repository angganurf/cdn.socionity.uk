			...
			<div className="min-h-[100svh] flex flex-col items-center justify-center p-4 relative overflow-hidden font-sans">
				...
				>
					<img
						...
						alt="Socio Cloud"
					/>
					<h1 className="text-2xl font-bold mb-6 text-center bg-clip-text text-transparent bg-gradient-to-b from-white to-muted-foreground">
						Upload your fck*ng image
					</h1>
					<div
						{...getRootProps()}
					...
					>
						...
						<p className="mt-2 text-sm text-balance text-gray-300">
							{isUploading
								? "Uploading..."
								: "Drag 'n' drop an godamn image here, or click to select one motherfucker"}
						</p>
					</div>
					<AnimatePresence>
						{error && (
				...
				>
					© {new Date().getFullYear()} Powered by Socionity
				</motion.div>
			</div>
		</ThemeProvider>
	);
